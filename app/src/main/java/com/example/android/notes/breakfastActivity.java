...
public class breakfastActivity extends Fragment {
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.activity_breakfast, container, false);
         ...
         ((MainActivity) getActivity()).setActionBarTitle("Breakfast");
        ...
        editdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(breakfastActivity.this.getActivity(),
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(isInserted == true)
                            ...
                            Toast.makeText( breakfastActivity.this.getActivity() ,"Saved Successfully!",Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(breakfastActivity.this.getActivity(),"Data not Inserted",Toast.LENGTH_LONG).show();
                        edititem.setText("");
                        editdate.setText("");
        ...
        btnDelete.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        editid.setText("");
                       if(deletedRow > 0)
                            Toast.makeText(breakfastActivity.this.getActivity(),"Data Deleted",Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(breakfastActivity.this.getActivity(),"Data not Deleted",Toast.LENGTH_LONG).show();
                    }
                }
